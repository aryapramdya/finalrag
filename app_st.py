...
#if "my_textarea_content" not in st.session_state:
#st.session_state["my_textarea_content"] = ""
...
with st.form("my_form"):
    ...
    text = st.text_area("Enter text:", placeholder="Who are the authors of DTSense Streamlit Module?")
